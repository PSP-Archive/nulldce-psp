...
int file_cmdl(wchar** arg,int cl)
{
	if (cl<1)
	{
		printf("-file : invalid number of parameters, format is -file <file>\n");
		return 0;
	}
...
int showhelp(wchar** arg,int cl)
{
	if (cl>=1)
	{
		...
		else if (strcmp(arg[1],"configfile")==0)
		{

/*
	SCIF was used for serial i/o on the dreamcast, its extenrally avaliable on the serial cable

	This file is much more interesting for the pc version.Maby
*/
...
{
	//no need to putc it -- its very rarely used anyway :)
}

...
ALIGN(32) u8 OnChipRAM[OnChipRAM_SIZE];
//All registers are 4 byte alligned

ALIGN(32) RegisterStruct CCN[20];
ALIGN(32) RegisterStruct UBC[20];
ALIGN(32) RegisterStruct BSC[20];
ALIGN(32) RegisterStruct DMAC[20];
ALIGN(32) RegisterStruct CPG[20];
ALIGN(32) RegisterStruct RTC[20];
ALIGN(32) RegisterStruct INTC[20];
ALIGN(32) RegisterStruct TMU[20];
ALIGN(32) RegisterStruct SCI[20];
ALIGN(32) RegisterStruct SCIF[20];

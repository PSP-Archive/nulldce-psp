...
extern ALIGN(32) RegisterStruct DMAC[20];		//DMAC : 17 registers
extern ALIGN(32) RegisterStruct CPG[20];		//CPG  : 5 registers
extern ALIGN(32) RegisterStruct RTC[20];		//RTC  : 16 registers
extern ALIGN(32) RegisterStruct INTC[20];		//INTC : 4 registers
